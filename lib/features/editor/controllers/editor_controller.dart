...
class EditorController extends ChangeNotifier {
  ...
  int _getNextZIndex() {
    ...
    return currentItems.map((e) => e.zIndex).reduce((a, b) => a > b ? a : b) + 1;
  }
  ...
  void updateTextItem(String itemId, {
    String? text,
    Color? textColor,
  ...
  void deleteItem(String itemId) {
    _itemsPerImage[_currentImageIndex]?.removeWhere((item) => item.id == itemId);
